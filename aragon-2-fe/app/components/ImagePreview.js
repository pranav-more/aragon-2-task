  ...
  return (
    <div className="flex flex-col">
      ...
      >
        ...
        {/* Subtle rejection indicator icon (top-left corner) */}
        {(currentStatus === "rejected" ||
          ...
          !isPreview && (
            <div className="absolute top-2 left-2 z-10">
              <svg
                ...
                className={clsx(
                  "h-5 w-5",
                  isDuplicate() ? "text-purple-300" : "text-red-400"
                )}
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
      ...
      {(currentStatus === "rejected" ||
        ...
        !isPreview && (
          <div
            className={clsx(
              "text-sm mt-1 px-1 py-1 rounded",
              isDuplicate()
          ...
          >
            <div className="flex items-start">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className={clsx(
                  "h-4 w-4 mr-1 mt-0.5 flex-shrink-0",
                  isDuplicate() ? "text-purple-600" : "text-red-600"
                )}
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              ...
              <span className="flex-1">{getImageRejectionReason()}</span>
            </div>
          </div>
        )}
